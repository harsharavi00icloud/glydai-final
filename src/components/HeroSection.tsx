        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto pt-24">
                <ScrollReveal delay={0.1}>
                    <h1
                        className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight tracking-tight"
                        style={{ color: "#fafafa" }}
                    >
                        <li> Grow beyond  </li>  $250k GCI with the best AI for realtors.
                    </h1>
                </ScrollReveal>

                <ScrollReveal delay={0.3}>
                    <p className="mt-6 text-base font-regular md:text-lg" style={{ color: "#a1a1aa" }}>
                        A white-glove AI service that delivers only results; not another dashboard to login.
                    </p>
                </ScrollReveal>

                <ScrollReveal delay={0.5}>
                    <Link href="/apply" className="btn-gold mt-10 font-extralight inline-block">
