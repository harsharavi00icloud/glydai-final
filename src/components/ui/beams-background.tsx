...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function resetBeam(beam: Beam, index: number, totalBeams: number) {
            ...
            // Alternate between gold and a faint warm-white for variety
            beam.hue = index % 4 === 0 ? 38 + (index * 15) / totalBeams : 40 + Math.random() * 10;
        ...
        function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
            ...
            // Gold palette: hue ~38-50, lowered saturation + lightness for subtlety
