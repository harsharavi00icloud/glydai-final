            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto pt-24">
                <ScrollReveal delay={0.1}>
                    <h1
                        ...
                        style={{ color: "#fafafa" }}
                    >
                        Build a Disgustingly Profitable Digital Business
                    </h1>
                </ScrollReveal>

                <ScrollReveal delay={0.3}>
                    <p className="mt-6 text-base md:text-lg max-w-2xl" style={{ color: "#a1a1aa" }}>
                        Quantum is where the top 1% of founders come to scale what already works.
                        We give you the infrastructure, insight, and unfair advantages normally
